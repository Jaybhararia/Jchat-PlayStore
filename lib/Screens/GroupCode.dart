...
import '../Existing_Chats/Existing_Chat_List.dart';
import '../Existing_Chats/Group_Details.dart';
...
To interact with groups in the app, use the following options:

1. Join a Pre-Created Group:
   If you want to join an existing group, enter the group's unique ID. By entering the group ID, you can easily access the ongoing conversation within that group.

2. Create a New Group:
   If you're interested in starting your own group, select the option to create a new group. A fresh group ID will be automatically generated for your new group. You can then invite others to join your conversation.

Using these features, you can seamlessly connect with others and participate in various discussions within the app.
                ''',
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      if (doesCollectionExist) {
                        Group_Details newGroup = Group_Details(Group_Code: code, Group_Description: "");
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar
                          ...
                          content: Text('ID Value Does Not Exist'),
                        ));
                      }
                    },
                    minWidth: 200.0,
